...
- [ ] 8. Expand capture-route status diagnostics with raw AndroidX connection type, UI mode, connection source, errors, and generated timestamps.
- [ ] 9. Add compact native route progress diagnostics for `AudioRecord` chunk delivery and update platform-wrapper tests/static checks for the hardened diagnostics.
