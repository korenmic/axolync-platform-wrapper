...
function buildNativeServiceCompanionHostSnippet() {
  const body = [
    ...
    '  const captureRouteDiagnostics = { latestStatus: null, latestStart: null, latestStop: null, latestError: null, latestChunk: null };',
    ...
    "      return plugin.addListener('captureRouteChunk', emitCaptureRouteChunk);",
    ...
    '    }',
    '  };',
    '  const setCaptureRouteChunkHandler = function(handler) {',
    "    captureRouteChunkHandler = typeof handler === 'function' ? handler : null;",
    '    if (captureRouteChunkHandler) void ensureCaptureRouteNativeListener();',
    "    return { status: 'success', providerKind: CAPTURE_ROUTE_PROVIDER_KIND, hasHandler: typeof captureRouteChunkHandler === 'function' };",
    '  };',
